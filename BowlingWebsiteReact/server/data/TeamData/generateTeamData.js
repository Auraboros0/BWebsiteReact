...
exports.generateTeamData = generateTeamData;
exports.identifyNewTeamData = identifyNewTeamData;
exports.getTourneyData = getTourneyData;
exports.getRecentTourneyData = getRecentTourneyData;
exports.getCombinedTLists = getCombinedTLists;
...
var pythonScript = node_path_1.default.resolve(dirname, "./teamResultsParser.py");
var mFolder = node_path_1.default.resolve(dirname, "./Mens_Results_Team");
var wFolder = node_path_1.default.resolve(dirname, "./Womens_Results_team");
...
function generateTeamData(male) {
    return __awaiter(this, void 0, void 0, function () {
        var objectName, folder, objectPath, teamDataSorted, tournamentNames, _i, folder_1, tournament, results, _a, results_1, row, tourneyName, tourneyDate, arrayFromTournamentSet, objectContents;
        var _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    if (male) {
                        objectName = "mensTeamResultsObject";
                        folder = mensCSVs;
                    }
                    else {
                        objectName = "womensTeamResultsObject";
                        folder = womensCSVs;
                    }
                ...
                case 2:
                    ...
                    for (_a = 0, results_1 = results; _a < results_1.length; _a++) {
                        ...
                        if (teamDataSorted[tourneyName]) {
                            (_b = teamDataSorted[tourneyName]) === null || _b === void 0 ? void 0 : _b.push(row);
                        }
                        else {
                            teamDataSorted[tourneyName] = [];
                            (_c = teamDataSorted[tourneyName]) === null || _c === void 0 ? void 0 : _c.push(row);
                        }
                    }
                    _d.label = 3;
                case 3:
                ...
                case 4:
                    ...
                    objectContents = "import type { teamResultsInterface } from \"../Interfaces/teamResultsInterface.ts\";\n    export const ".concat(objectName, ": Record<string, teamResultsInterface[]> = ").concat(JSON.stringify(teamDataSorted, null, 4), "\n    export const tournamentSet: [string, string][] = ").concat(JSON.stringify(arrayFromTournamentSet));
                    node_fs_1.default.writeFileSync(objectPath, objectContents);
                    return [2 /*return*/, { teamDataSorted: teamDataSorted, arrayFromTournamentSet: arrayFromTournamentSet }];
            }
        });
    });
}
/* Identifies new CSV files by comparing the tournament set to the CSV folder */
function identifyNewTeamData(male, memoryTList) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./mensTeamResultsObject.ts'); })];
                case 6:
                ...
                case 7:
                    ...
                    folder = mensCSVs;
                    return [3 /*break*/, 11];
                case 8: return [4 /*yield*/, Promise.resolve().then(function () { return require('./womensTeamResultsObject.ts'); })];
                case 9:
                    playersObject = _a.sent();
                    tList = playersObject.tournamentSet.map(function (item) { return item[0]; });
...
function getTourneyData(male, name, dataFromMemory) {
    return __awaiter(this, void 0, void 0, function () {
        var toReturn, tourneyData, toReturn;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(typeof dataFromMemory !== 'undefined')) return [3 /*break*/, 1];
                    toReturn = dataFromMemory[name];
                ...
                case 2:
                    ...
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, Promise.resolve().then(function () { return require('./womensTeamResultsObject.ts'); })];
                case 4:
                    tourneyData = _a.sent();
...
function getRecentTourneyData(male, dataFromMemory, tournamentSet) {
    return __awaiter(this, void 0, void 0, function () {
        var tourney, ourEntry, _i, _a, entry, placement, outOf, name_1, tObject, tData, tourney, ourEntry, _b, _c, entry, placement, outOf, name_2;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    if (!(typeof dataFromMemory !== 'undefined' && typeof tournamentSet !== 'undefined')) return [3 /*break*/, 1];
                    tourney = dataFromMemory[tournamentSet.at(-1)[0]];
                    if (typeof tourney === 'undefined') {
                        return [2 /*return*/, { placement: 0, outOf: 0, name: "" }];
                    }
                    ourEntry = void 0;
                    for (_i = 0, _a = tourney; _i < _a.length; _i++) {
                        entry = _a[_i];
                    ...
                    placement = ourEntry.No;
                    outOf = Object.keys(tourney).length;
                    name_1 = ourEntry.tournamentName;
                    return [2 /*return*/, { placement: placement, outOf: outOf, name: name_1 }];
                case 1:
                    tObject = void 0;
                    tData = void 0;
                    if (!male) return [3 /*break*/, 3];
                ...
                case 4:
                    ...
                    _d.label = 5;
                case 5:
                    tourney = tData[Object.keys(tData).at(-1)];
                    if (typeof tourney === 'undefined') {
                        return [2 /*return*/, { placement: 0, outOf: 0, name: "" }];
                    }
                    ourEntry = void 0;
                    for (_b = 0, _c = tourney; _b < _c.length; _b++) {
                        entry = _c[_b];
                        if (entry.Team_Name == "Wisc.-Madison") {
                            ourEntry = entry;
                            break;
                    ...
                    placement = ourEntry === null || ourEntry === void 0 ? void 0 : ourEntry.No;
                    outOf = Object.keys(tourney).length;
                    name_2 = ourEntry === null || ourEntry === void 0 ? void 0 : ourEntry.tournamentName;
                    return [2 /*return*/, { placement: placement, outOf: outOf, name: name_2 }];
            }
        });
    });
}
...
function getCombinedTLists(memoryM, memoryF) {
    return __awaiter(this, void 0, void 0, function () {
        var tListReturned, iteratorM, iteratorF, _i, memoryM_1, m, _a, memoryF_1, f;
        return __generator(this, function (_b) {
            tListReturned = {};
            iteratorM = 0;
            iteratorF = 0;
            for (_i = 0, memoryM_1 = memoryM; _i < memoryM_1.length; _i++) {
                m = memoryM_1[_i];
                tListReturned[m[0]] = [0, m[1]];
                iteratorM++;
            }
            for (_a = 0, memoryF_1 = memoryF; _a < memoryF_1.length; _a++) {
                f = memoryF_1[_a];
